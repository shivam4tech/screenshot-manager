...
fn main() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::cleanup_category_ids,
            commands::cleanup_trash,
            commands::cleanup_sizes,
            ...
            commands::suggest_for_screenshot,
            commands::suggestion_overview,
            commands::record_suggestion_feedback,
            commands::accept_collection_suggestion,
            commands::accept_tag_suggestion,
            commands::create_proposed_collection,
